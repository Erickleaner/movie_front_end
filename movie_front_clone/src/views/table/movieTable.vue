<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="Rating" width="150px">
        <template slot-scope="{row}">
...
import {fetchCountries, fetchList, insert, remove, update} from '@/api/manageMovie' // secondary package based on el-pagination
